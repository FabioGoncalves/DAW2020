...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="ARQELEM" mode="indice">
        <li>
            <a name="/i{count(preceding::IDENTI)+1}"/>
            <a href="http://localhost:7777/Arq/{count(preceding::IDENTI)+1}">
    ...
    <xsl:template match="ARQELEM">
        <xsl:result-document href="site/{count(preceding::ARQELEM)+1}.html">
            <html>
                <head>
                ...
                <body>
                    ...
                    <address>
                        [<a href="http://localhost:7777/index.html#i{count(preceding::IDENTI)+1}">Voltar à home</a>]
                    </address>
                    <address>
                        [<a href="http://localhost:7777/Arq/{count(preceding::IDENTI)+2}">Seguinte</a>]
                    </address>
                    <address>
                        [<a href="http://localhost:7777/Arq/{count(preceding::IDENTI)}">Retroceder</a>]
                    </address>
